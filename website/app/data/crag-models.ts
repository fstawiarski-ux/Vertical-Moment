...
export const cragModels: CragModel[] = [
  {
    ...
    summary:
      'RealityScan LOD0 of the Bergsteiger wall, prepared as a lazy-loaded browser model with 344,107 vertices and approximately 500,020 triangles.',
    routes: 'Topo in progress',
    captured: 'RealityScan · optimized LOD0 · 16.76 MiB',
    scanned: true,
    panoramaHref: '/panoramas/wachau/nasenwand',
